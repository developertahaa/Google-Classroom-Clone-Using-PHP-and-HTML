...
$t_email = $_SESSION['user_email'];
$teacherQuery = "SELECT name FROM users WHERE email = '$t_email'";
...
if (isset($_POST['submit'])) {
    ...
    // Generate a random alphanumeric 6-digit code for room number
    $room_no = generateRandomCode(6);

    // Assuming you have the email in the session (replace 'user_email' with your actual session variable)
    $email = $_SESSION['user_email'];

    $insert_query = "INSERT INTO classes (class_name, section, subject, room_no, t_email) VALUES ('$class_name', '$section', '$subject', '$room_no', '$email')";
    ...
    <div class="row">
        <div class="col-md-3 sidebar" style="height: 150vh;">
            ...
            <div class="archived" style="margin-top: 20px;">
                <i class="fa fa-archive"
                   style="font-size: 20px !important; color: #007bff; margin-right:-25px; margin-left: -15px;"></i>
                <a href="" class="ar-class">Archived Classes</a>
            </div><br>
            <div class="archived" style="margin-top: 20px;">
                <i class="fa fa-gear"
                   style="font-size: 20px !important; color: #007bff; margin-right:-25px; margin-left: -15px;"></i>
                <a href="profile.php" class="ar-class">Settings</a>
            </div>
            <script>
        ...
        <div class="col-md-9 main-content">
            <div class="content">
                ...
                // Fetch all data from the classes table
                $select_query = "SELECT * FROM classes";
                $result = mysqli_query($conn, $select_query);
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<div class="card-body" style="text-align: left; margin-top: -130px; margin-bottom: 40px; position: relative; z-index: 1;">';
                    ...
                    echo '<p>Create a class to get started</p>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addClassModalLabel">Create Class</h5>
