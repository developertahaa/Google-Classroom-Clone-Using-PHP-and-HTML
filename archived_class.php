...
$stdQuery = "SELECT code FROM archived WHERE s_email = '$std_email'";
                        ...
                        <li style="text-align:left;">
                            <button class="btn btn-link menu-button"
                                ...
                                <i class="fa fa-home icon" style="margin-right: -20px;"></i><a
                                        href="student_view.php" style="text-decoration: none; color: black;">Home</a>
                            </button>
                        </li><br>
                        <li style="text-align:left;">
                            <button class="btn btn-link menu-button"
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<div class="card-settings" style="margin-left: 265px; margin-top: -40px;">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"">
                                    <a class="dropdown-item" href="archived.php?enroll='.$code.'"">enroll</a>
                                </div>
                            </div>';
...
if (empty($codes)) {
    ...
    echo '<p>No Archived Classes to Show</p>';
    echo '  <a href="student_view.php" class="btn btn-danger logout-btn">Go Back</a>';
